# MySQL <-> SQLite network proxy – `mysql2`-based TypeScript edition
...
This example delegates the MySQL binary protocol processing to the `mysql2` Node.js library.
...
```bash
cd typescript-nodejs-with-mysql2
bun mysql-server.ts 
